document.addEventListener('DOMContentLoaded', async () => {
    // 1. Verificamos la "pulsera VIP" (Token)
    ...
    if (formInfo) {
        formInfo.addEventListener('submit', async (e) => {
            ...
            // Capturamos todos los valores de tus inputs
            ...
            try {
                ...
                if (res.ok) {
                    // Actualizamos la tarjeta visual al instante para que se vea el cambio
            ...
            try {
                const res = await fetch('http://localhost:3000/api/auth/me/password', {
                    ...
                    body: JSON.stringify({ 
                        ...
                        new_password: nueva,
                        confirm_password: nueva // Enviamos la misma para validar en el backend
                    })
                });
